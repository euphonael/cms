...
class Model_project extends CI_Model {
	...
	{
		$query = $this->db->select('project.unique_id, project_name, project_price, project_bank_id, project_sales_id, project_product_id, project_customer_type, project_markup, project_note, client_name AS project_client_name, company_name AS project_company_name, project_top, project_top_percent, project.flag, project.memo')->join('bank', 'bank.unique_id = project_bank_id', 'left')->join('company', 'company.unique_id = project_company_id', 'left')->join('client', 'client.unique_id = project_client_id', 'left')->where('project.unique_id', $unique_id)->get($this->db_table);
	...
	public function insert()
	{
		$data = array(
			...
			'project_top_percent'	=> implode(',', $this->input->post('project_top')),
