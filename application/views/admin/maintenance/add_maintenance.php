        	...
        	<div id="form-left">
                <fieldset>
                    ...
                    <p>
                        ...
                        <input type="text" name="maintenance_period" id="maintenance_period" class="digits required" title="Number of months" value="<?php echo set_value('maintenance_period'); ?>" />
                        <?php echo form_error('maintenance_period'); ?>
                    </p>
                    <p>
                        <label class="label-input" for="maintenance_price">Price</label>
                        <input type="text" name="maintenance_price" id="maintenance_price" class="digits required" value="<?php echo set_value('maintenance_price'); ?>" />
                        <?php echo form_error('maintenance_price'); ?>
                    </p>
                    <p>
                        <label class="label-input" for="maintenance_extend">Extend</label>
                        <input type="text" name="maintenance_extend" id="maintenance_extend" class="digits" value="<?php echo set_value('maintenance_extend'); ?>" />
                ...
                <fieldset>
                    ...
                    <p>
                        ...
                        <select name="maintenance_company_id" class="required">
                            ...
                            <option value="<?php echo $item['unique_id']; ?>" <?php if (set_value('maintenance_company_id') == $item['unique_id']) echo 'selected="selected"'; ?>><?php echo $item['company_name']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <p>
                        ...
                        <select name="maintenance_bank_id" class="required">
                            ...
                            <option value="<?php echo $item['unique_id']; ?>" <?php if (set_value('maintenance_bank_id') == $item['unique_id']) echo 'selected="selected"'; ?>><?php echo $item['bank_name']; ?></option>
                            <?php endforeach; ?>
                        </select>
