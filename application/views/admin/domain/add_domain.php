        	...
        	<div id="form-left">
                <fieldset>
                    ...
                    <p>
                        ...
                        <input type="text" name="domain_name" id="domain_name" class="required" value="<?php echo set_value('domain_name'); ?>" />
                        <?php echo form_error('domain_name'); ?>
                    </p>
                    <p>
                        <label class="label-input" for="domain_location">Domain Location</label>
                        <input type="text" name="domain_location" id="domain_location" class="required" value="<?php echo set_value('domain_location'); ?>" />
