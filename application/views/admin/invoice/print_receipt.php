...
<title>Receipt No: <?=$row[0]['invoice_number']?></title>
</head>
...
<div id="header" style="margin:0;padding:0;height:155px;border-bottom:1px solid #CCC; width:595px;">
    ...
    <div style="margin:0; padding:0; clear:both;"></div>
   	...
   	<h1 style="display:block; font-weight:bold; font-variant:small-caps; float:right; margin:0;padding:0;color:#3399cc;font-size:30px; margin-top:10px;">Receipt</h1>
...
<div id="content" style="margin:0;padding:0;margin-top:15px; width:595px;">
    ...
    Receipt: <?=$row[0]['invoice_number']?><br style="margin:0; padding:0;">
    </div>
